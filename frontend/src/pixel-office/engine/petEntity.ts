...
import type { PetSpriteFrames } from '../sprites/petSpriteData';
import type { Character, Pet, SpriteData, TileType as TileTypeVal } from '../types';
import { Direction, PetState, TILE_SIZE } from '../types';
