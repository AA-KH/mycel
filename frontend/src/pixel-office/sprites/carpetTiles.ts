...
import { CARPET_DEFAULT_ACCENT_COLOR, CARPET_DEFAULT_COLOR } from '../../constants';
import { flatColorizeSprite } from '../colorize';
import type { CarpetTile, SpriteData } from '../types';
