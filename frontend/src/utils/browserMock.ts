...
import { setCharacterTemplates } from '../pixel-office/sprites/spriteData';
import { setFloorSprites } from '../pixel-office/floorTiles';
import { setWallSprites } from '../pixel-office/wallTiles';
import { buildDynamicCatalog } from '../pixel-office/layout/furnitureCatalog';

export function loadOfficeAssets(): any {
  ...
  buildDynamicCatalog({ catalog: furnitureCatalog, sprites: furnitureSprites });

  console.log('[BrowserMock] Assets injected into pixel-office engine');
  return layout;
}
