...
/** Base font size (pixel-pre-zoom) for compact in-world room plaques. */
export const AREA_LABEL_FONT_SIZE_PX = 9;
/** Minimum on-screen label size to keep plaques readable at low zoom. */
export const AREA_LABEL_MIN_FONT_SIZE_PX = 8;
